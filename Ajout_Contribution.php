...
function Aff_Pers($suffixe, $oblig)
{
	...
	if ($suffixe != 'conj') {
		...
		echo '<img id="copier_' . $suffixe . '" src="' . $chemin_images . $Icones['copier'] . '" alt="' . $texte_im . '" title="' . $texte_im . '"' .
	...
	echo '<img src="' . $chemin_images . $Icones['localisation'] . '" alt="Sélection ville" onclick="Appelle_Zone_Naissance(\'' . $suffixe . '\')"/>' . "\n";
	echo '</td></tr>';
	...
	echo '<img src="' . $chemin_images . $Icones['localisation'] . '" alt="Sélection ville" onclick="Appelle_Zone_Deces(\'' . $suffixe . '\')"/>' . "\n";
	echo '</td></tr>';
	echo '</table>';
}
