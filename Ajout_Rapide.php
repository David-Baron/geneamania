...
{
	global $style_z_oblig, $enregP, $list_opt_villes, $idNomPers, $Nom, $Sexe, $chemin_images, $Icones, $hidden, $largP, $lg_date_a;
	...
	echo '<img id="ajout_nom' . $suffixe . '" src="' . $chemin_images . $Icones['ajout'] . '" alt="' . $texte_im . '" title="' . $texte_im . '" ' .
	...
	echo ' <img id="majuscule' . $suffixe . '" src="' . $chemin_images . $Icones['majuscule'] . '" alt="' . $texte_im . '" title="' . $texte_im . '"' .
	...
	if (($suffixe != 'pere') and ($suffixe != 'mere')) {
		...
		echo '<td><input type="radio" name="Sexe' . $suffixe . '" value="m" ' . $Sexe_Checked_m . '/>Homme ';
		echo '<input type="radio" name="Sexe' . $suffixe . '" value="f" ' . $Sexe_Checked_f . '/>Femme' . "\n";
		echo '</td></tr>';
	}
