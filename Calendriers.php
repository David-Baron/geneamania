...
{
    global $chemin_images, $Icones, $def_enc;
    echo '<div id="boutons' . $nb . '">' . "\n";
    echo '<table border="0" cellpadding="0" cellspacing="0">' . "\n";
    echo '<tr><td>';
    echo '<div class="buttons">';
    echo '<button type="submit" class="positive">';
    if ($txt == 'Convertir') echo '<img src="' . $chemin_images . $Icones['conversion'] . '" alt=""/>';
...
<!--
  ...
  <a href="#calrep">Calendrier républicain</a> |
...
echo '  <p>Date Républicaine : <input type="text" size="2" maxlength="2" name="JourRep" value="' . $JourRep . '"/>';
...
Ecrit_Mois('green', 8, 'Floréal', $MoisRep);
...
Ecrit_Mois('silver', 4, 'Nivôse', $MoisRep);
Ecrit_Mois('silver', 5, 'Pluviôse', $MoisRep);
Ecrit_Mois('green', 9, 'Prairial', $MoisRep);
Ecrit_Mois('Yellow', 11, 'Thermidor', $MoisRep);
Ecrit_Mois('maroon', 1, 'Vendémiaire', $MoisRep);
Ecrit_Mois('silver', 6, 'Ventôse', $MoisRep);
