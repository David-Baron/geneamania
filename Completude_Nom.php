...
if ($res->RowCount() > 0) {
	...
	// Sortie écran
		...
		$echo_verif = Affiche_Icone('fiche_controle', my_html(LG_PERS_CONTROL)) . '</a> ';

		$img_vert   = '<img src="' . $chemin_images . $Icones['drapeau_vert'] . '" border="0" alt="Drapeau vert"/>';
		$img_orange = '<img src="' . $chemin_images . $Icones['drapeau_orange'] . '" border="0" alt="Drapeau orange"/>';
		$img_rouge  = '<img src="' . $chemin_images . $Icones['drapeau_rouge'] . '" border="0" alt="Drapeau rouge"/>';
