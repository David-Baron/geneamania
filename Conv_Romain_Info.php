...
<head>
    ...
    il doit ensuite cliquer sur le bouton conversion ou se positionner dans la zone de saisie et appuyer sur la touche "Entrée".<br />
    L'icône <?php echo Affiche_Icone('efface', 'efface'); ?> permet d'effacer la zone de saisie.<br />
    Les nombres arabes sont limités à 3999.<br />
    Les saisies de lettres romaines peuvent être faites en minuscules ou majuscules.
    </body>
