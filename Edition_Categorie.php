...
if ((!$bt_OK) && (!$bt_An)) {
	...
	echo '<td class="value">';
	echo '<img src="' . $chemin_images . $Icones['moins'] . '" alt="' . $LG_Ch_Categ_Dec_Order . '" title="' . $LG_Ch_Categ_Dec_Order . '" border="0" ';
	...
	echo '<img src="' . $chemin_images . $Icones['plus'] . '" alt="' . $LG_Ch_Categ_Inc_Order . '" title="' . $LG_Ch_Categ_Inc_Order . '" border="0" ';
	...
	echo '<td class="value">';
	echo '<img src="' . $chemin_images . $Icones['tag_' . $enreg['Image']] . '" border="0" alt="' . $TitreF . '" title="' . $TitreF . '"/>';
	echo '</td></tr>' . "\n";
