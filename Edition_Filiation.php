...
{
	global $chemin_images, $Comportement, $Icones, $Images, $Refer, $Nom,
	...
	if (!$LaMere) echo ' <input type="button" onclick="sel_derP(\'f\')" value="Dernière femme saisie" name="DF"/>';
	...
	echo '<td>';
	echo '<img src="' . $chemin_images . $Icones['moins'] . '" alt="' . $LG_Ch_Filiation_Rank_Dec . '" title="' . $LG_Ch_Filiation_Rank_Dec . '" border="0" ';
	...
	echo '<img src="' . $chemin_images . $Icones['plus'] . '" alt="' . $LG_Ch_Filiation_Rank_Inc . '" title="' . $LG_Ch_Filiation_Rank_Inc . '" border="0" ';
	...
	echo '<tr><td>' . my_html(LG_CH_COMMENT_VISIBILITY) . ' <input type="checkbox" name="Diff_Internet_NoteF" value="O"';
