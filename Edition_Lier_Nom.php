...
if ((!$bt_OK) && (!$bt_An) && (!$bt_Sup)) {
	...
	if (Get_Nom_Prenoms($refPers, $Nom, $Prenoms)) {
		...
		if ($refNom == -1) {
			...
			echo '<img id="ajout_nom" src="' . $chemin_images . $Icones['ajout'] . '" alt="' . $texte_im . '" title="' . $texte_im . '"' .
			...
			echo '&nbsp;<img id="majuscule" src="' . $chemin_images . $Icones['majuscule'] . '" alt="' . $texte_im . '" title="' . $texte_im . '"' .
...
<script type="text/javascript">
	// On cache les div d'ajout du nom et on positionne l'onglet par défaut
