...
if (((!$bt_OK) && (!$bt_An) && (!$bt_Sup)) || $mesErreur != '') {
	...
	echo ' <img src="' . $chemin_images . $Icones['copier'] . '" alt = "' . LG_UTIL_PSW_COPY . '" title = "' . LG_UTIL_PSW_COPY
	...
	echo '<button type="submit" class="positive" ' .
		...
		'<img src="' . $chemin_images . $Icones['fiche_validee'] . '" alt=""/>' . $lib_Okay . '</button>';
	echo '<button type="submit" ' .
		'onclick="document.forms.saisie.cache.value=\'an\';document.forms.saisie.annuler.value=\'' . $lib_Annuler . '\';"> ' .
		'<img src="' . $chemin_images . $Icones['cancel'] . '" alt=""/>' . $lib_Annuler . '</button>';
	if ($lib_sup != '')
