...
$tab_variables = array(
	'ok', 'annuler', 'Sexe', 'Numero', 'Ne_le', 'Ville_Naissance', 'Decede_Le', 'Ville_Deces', 'prof', 'parents', 'conjoints', 'comment', 'arr_unions_1', 'arr_unions_2'
);
...
if ($bt_An) Retour_Ar();
	...
	Insere_Haut($titre . ' pour ' . $pers1['Prenoms'] . ' ' . $pers1['Nom'], '', 'Fiche_Homonymes', '');
