...
echo '<td>' . my_html(LG_CONTRIB_LIST_IGNORE);
...
echo '<tr>' . "\n";
echo '<th>' . my_html(LG_CONTRIB_LIST_CONTRIB) . '</th>';
echo '<th>' . my_html(LG_CONTRIB_LIST_PERSON) . '</th>';
echo '<th>' . my_html(LG_CONTRIB_LIST_WHEN) . '</th>' . "\n";
echo '<th>&nbsp;</th>' . "\n";
echo '</tr>' . "\n";
