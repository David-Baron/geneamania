...
$fin_mod = '<img src="' . $chemin_images . $Icones['fiche_edition'] . '" border="0" alt="' . $LG_modify . '" title="' . $LG_modify . '"/></a>' . "\n";
...
while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
	...
	if ($Nouv_Type != $Anc_Type) {
		...
		echo '  <img id="ajout' . $suf . '" src="' . $chemin_images . $Icones['oeil'] . '" alt="' . LG_LINKS_EYE . '" ' .
