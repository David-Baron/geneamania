...
<ul>
    ...
    <li>acte de Mariage<br />
        Il comporte :
        <ul type="circle">
            <li>Les noms et prénoms et situation (majeur, mineur, veuf, veuve&hellip;) des époux ; leur âge (parfois) et lieu de
            ...
            <li>Des mentions diverses : <a href="<?php echo Get_Adr_Base_Ref(); ?>glossaire_gen.php#dispenseC">dispenses de
                    consanguinité</a>,
                <a href="<?php echo Get_Adr_Base_Ref(); ?>glossaire_gen.php#dispenseA">d'affinité</a>, reconnaissance d'un enfant né avant le mariage.<br /><br />
            </li>
        </ul>
    </li>
