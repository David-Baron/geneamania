...
$im_moins = '<img src="' . $chemin_images . $Icones['moins'] . '" alt="' . LG_STAT_GEN_DEC . '" title="' . LG_STAT_GEN_DEC . '" border="0" ';
$im_plus = '<img src="' . $chemin_images . $Icones['plus'] . '" alt="' . LG_STAT_GEN_INC . '" title="' . LG_STAT_GEN_INC . '" border="0" ';
