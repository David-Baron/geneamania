...
echo '<th>' . my_html(LG_CHK_INTERNET_PERSON) . '</th>' . "\n";
echo '<th>' . my_html($LG_show_on_internet);
echo ' <input type="checkbox" name="selTous" value="on" checked="checked" onclick="checkUncheckAll(this);"/> ' . my_html($LG_All);
echo '</th>' . "\n";
echo '<th>' . my_html(LG_CHK_INTERNET_BORN) . '</th>' . "\n";
echo '<th>' . my_html(LG_CHK_INTERNET_DEATH) . '</th>' . "\n";
echo '</tr>' . "\n";
$numLig = 0;
