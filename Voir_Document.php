...
function afficheHTM()
{
	...
	//	Suppression de tout ce qui est apr�s la balise de fin BODY
	$position = stripos($contenu , "</body>");
	if ($position)
	{
...
if ($natureDoc == 'PDF') {
	...
	//<a href="chemin/vers/ton/document.doc" type="application/msword">intitul� de ton document (format Word, poids du document)</a>
