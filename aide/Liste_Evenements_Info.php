...
<head>
    ...
    L'utilisateur peut choisir le type de d'évènement pour lequel il veut la liste (par défaut tous les types sont visualisés). Il dispose alors en plus du titre de l'évènement
