...
<head>
    ...
    <ul>
        <li>si vous êtes le gestionnaire du site, cliquez <a href="http://genealogies.geneamania.net/demande_code_gest.php">ici</a> 
        pour régénérer un mot de passe gestionnaire</li>
