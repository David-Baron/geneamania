...
<head>
    ...
    echo '<button type="submit" class="positive" onclick="lien();"><img src="' . $chemin_images . $Icones['fiche_validee'] . '" alt=""/>' . $lib_Okay . '</button>';
    echo '<button type="submit" onclick="window.close();"><img src="' . $chemin_images . $Icones['cancel'] . '" alt=""/>' . $lib_Annuler . '</button>';
    echo '<button type="submit" class="negative" onclick="efface();"><img src="' . $chemin_images . $Icones['supprimer'] . '" alt=""/>' . $lib_Erase . '</button>';
    echo '</div>';
    echo '</td></tr>';
    echo '</table>';
    ...
    <script type="text/javascript">
        ...
        function lien() {
            ...
            // Contrôle de la date
            var laDate_OK = date_valide(laDate);
