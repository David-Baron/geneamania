...
// Graphisme
$dominante = 'marron';
//echo 'Proposition de graphismes (des paramètres plus complets sont disponibles dans Gestion du site / graphisme du site)<br /><br />'."\n";
echo '<table width="85%" class="table_form">' . "\n";
echo '<tr align="center">';
echo '<td width="30%">';
echo 'Fond de page et première lettre accueil<br />';
...
echo '<tr>';
echo '<td id="case_form_lib" width="40%" style="background-color:' . $gra_coul_lib[$dominante] . ';">Couleur de fond de la case libellé</td>';
...
echo '3ème Génération  <img id="ajout3" src="Images/eye.png" alt="Afficher / masquer" title="Afficher / masquer"/>';
echo '</td></tr></table>';
echo '<table width="95%" border="0" class="classic" cellspacing="1" cellpadding="3" align="center">';
...
echo '<td width="48%">MARTIN Maurice Théodule François</td>';
...
echo '<td width="48%">DULAC Solange Eugénie</td>';
