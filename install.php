...
<head>
	...
	echo '<h1>Installation de Généamania v' . $LaVersion . '</h1>' . "\n";
	echo '</td></tr>' . "\n";
	echo '</table>' . "\n";

	// Récupération des variables de l'affichage précédent
	$tab_variables = array(
		'tester', 'majparam', 'Supprimer', 'maj', 'eff', 'conf_eff', 'majsource',
	...
	if ($tester == 'Tester') {
		...
		if (!$cnx) {
			...
			echo 'les paramètres saisis sont corrects, vous pouvez les enregistrer...<br />';
		}
	}
	...
	if (!$cnx) {
		...
		echo "    <td>Tester les paramètres saisis</td>\n";
		echo "    <td>Mettre à jour les paramètres</td>\n";
		echo "  </tr>\n";
		echo '  <tr align="center">' . "\n";
		...
		if ($Version != '') {
			if ($Version != $LaVersion) {
				...
				echo '<i>NB : un <a href="Export.php">export</a> complet de la base est conseillé avant de demander la migration.</i>' . "\n";
		...
		echo '<a href="http://forum.geneamania.net/" target="_blank">Forum Généamania</a><br />' . "\n";
		if ($Version != '') {
