...
$x = Ecrit_Meta('Installation de G&eacute;n&eacute;amania','Installation Généamania','');
...
if ($tester == 'Tester') {
	...
	if (!$cnx) {
		...
		echo 'les param&egrave;tres saisis sont corrects, vous pouvez les enregistrer...<br />';
	}
}
...
if (!$cnx) {
	...
	echo '<a href="http://forum.geneamania.net/" target="_blank">Forum G&eacute;n&eacute;amania</a><br />'."\n";
	if ($Version != '') {
