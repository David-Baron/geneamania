...
if ($nom_page == 'Edition_Lier_Eve.php') {
	...
	$LG_Link_Ev_Pers_Event_Type = 'Type d\'évènement';
	$LG_Link_Ev_Pers_Event = 'Evènement';
	$LG_Link_Ev_Pers_Last_Event = 'Dernier évènement pour le type';
	$LG_Link_Ev_Pers_Role = 'Rôle';
	$LG_Link_Ev_Pers_Place = 'Lieu de la participation';
	$LG_Link_Ev_Pers_Beg_Part = 'Début de la participation';
	$LG_Link_Ev_Pers_End_Part = 'Fin de la participation';
	$LG_Link_Ev_Pers_Paste_Beg = 'Copier la date de début';
	$LG_Link_Ev_Pers_Save_GeneGraphe = 'Participation prise en compte dans GénéGraphe';
...
if (in_array($nom_page,array('Import_CSV_Villes.php',
	...
	define('LG_ICSV_TOWN_SEARCH', 'Recherche de la ville dans la base des villes Généamania');
...
if ($nom_page == 'Recherche_Cousinage.php') {
	...
	define('LG_CH_RELATED_TIP_BEG', 'recherche limitée ');
...
if (($nom_page == 'Edition_Image.php') or ($nom_page == 'Liste_Images.php')) {
	...
	$LG_Ch_Image_Visibility = "Visibilité de l'image sur internet";
...
if ($nom_page == 'Import_Sauvegarde.php') {
	...
	define('LG_IMP_BACKUP_READ_LINES', 'lignes traitées');
...
$LG_Data_noavailable_profile = 'Données non disponibles pour votre profil';
...
if (!is_info()) {
	...
	$LG_Menu_Title['Event_Type_Add']			= 'Création d\'un type de document';
