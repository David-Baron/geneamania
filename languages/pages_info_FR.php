...
switch ($aide) {
	...
	case 'Ajout_Rapide' : 
		...
		echo "Les dates peuvent être choisies en cliquant sur l'icône ".Affiche_Icone('calendrier','calendrier')."<br />";
		echo $auto_contrib;
		break;
	case 'Anniversaires' : 
		...
		echo "Les icônes ".Affiche_Icone('anniv_nai','Anniversaire de naissance').'&nbsp;'
	...
	case 'Calc_So' : 
		...
		echo "L'icône ".Affiche_Icone('efface','efface')." permet d'effacer la zone de saisie.<br />";
		break;
	case 'Completude_Nom' : 
		...
		echo "<li>la présence d'un conjoint avec une date et un lieu d'union (si la personne est décédée après l'âge de 15 ans).</li>";
		echo "</ul>";
	...
	case 'Edition_Evenement' : 
		...
		echo "Le lieu de survenance de l'évènement peut être choisi en cliquant sur l'icône ".Affiche_Icone('localisation','localisation')."<br />";
		echo "Les dates de début et de fin peuvent être choisis en cliquant sur l'icône ".Affiche_Icone('calendrier','calendrier')."&nbsp;";
		echo "alors que l'icône ".Affiche_Icone('copie_calend','copie')." permet de copier la date de début dans la date de fin.<br />";
	...
	case 'Edition_Lier_Pers' : 
		...
		echo "Les dates de début et de fin peuvent être choisies en cliquant sur l'icône ".Affiche_Icone('calendrier','calendrier')."&nbsp;";
		echo "alors que l'icône ".Affiche_Icone('copie_calend','copie')." permet de copier la date de début dans la date de fin.<br />";
		echo $auto_contrib;
		break;
	case 'Edition_NomFam' : 
		...
		echo "en minuscules puis cliquer sur l'icône ".Affiche_Icone('majuscule','majuscule')." pour mettre le nom en majuscules.<br />";
		echo "<br /><b>Prononciation</b><br />";
		echo "Pour la prononciation du nom, le bouton &laquo; Prononciation calculée &raquo; détermine une prononciation du nom à partir des règles de prononciation du français.";
	...
	case 'Edition_Personne' : 
		...
		echo "La date de naissance ou de décès peut être choisie en cliquant sur l'icône ".Affiche_Icone('calendrier','calendrier')."<br />";
		echo "Les professions sont gérées dans les évènements.<br />";
		echo "L'icône ".Affiche_Icone('ajout','ajout ville')." permet d'ajouter dynamiquement une ville aux listes des villes de naissance ou de décès.<br />";
		echo "L'icône ".Affiche_Icone('calculette','calculette')." permet de calculer le numéro sosa à partir de la saisie effectuée par l'utilisateur dans le numéro. ";
		...
		echo "<br />";
		echo "L'icône ".Affiche_Icone('decujus','de cujus')." permet d'attribuer automatiquement le numéro 1 (de cujus) à la personne.<br />";
		echo "L'icône ".Affiche_Icone('copier','copie')." permet de coller le nom, la ville de naissance ou de décès de la fiche précédente sur laquelle était l'utilisateur en création ou modification.<br />";
		echo "<br />";
	...
	case 'Edition_Rangs' : 
		...
		echo "En cas de divergence entre le rang théorique et le rang saisi, la zone du rang calculé est suivie de l'icône ".Affiche_Icone('warning','Alerte');
		...
		echo 'Si l\'écart avec l\'enfant précédent est de moins de 9 mois, la zone "Ecart calculé" est suivie de l\'icône '.Affiche_Icone('warning','Alerte')."<br />";
		break;
	...
	case 'Export' : 
		...
		echo "L'icône ".Affiche_Icone('oeil','oeil')." permet de visualiser la liste des tables à exporter ; l'utilisateur";
		...
		echo 'le modificateur de nom de fichier éventuel est inséré après la chaîne "Export_".<br />';
		echo "Cette page n'est disponible que pour le profil gestionnaire.";
		break;
	...
	case 'Histo_Ages_Deces' : 
		echo "Cette page permet de visualiser la répartition des âges de décès des personnes contenues dans la base pour une période de naissance donnée.";
		...
		echo "Contrairement à l'historique de l'âge, les enfants décédés avant l'âge de 1 an sont pris en compte.<br />";
		echo "Pour chaque tranche d'âge, le nombre de personnes et le pourcentage que cela représente sont précisés.";
		break;
	case 'Histo_Ages_Mariage' : 
		echo "Cette page permet de visualiser la répartition des âges de premier mariage des personnes contenues dans la base pour une période de naissance donnée.";
		...
		echo "Pour chaque tranche d'âge sont précisés le nombre de personnes et le pourcentage que cela représente.";
		break;
	case 'Import_CSV' : 
	...
	case 'Import_Gedcom' : 
		...
		echo "L'icône ".Affiche_Icone('efface','Efface le format des lieux')." permet d'effacer le format des lieux précédemment sélectionné.";
	...
	case 'Liste_NomFam' : 
		...
		echo "à partir de la liste, vous pouvez afficher un nom de famille et éventuellement le modifier.<br />";
	...
	case 'Pyramide_Ages_Histo' : 
		echo "Cette page permet de visualiser l'évolution (en fonction de l'année de naissance) de l'âge au décès des personnes contenues dans la base.";
		...
		echo "De plus, les enfants décédés avant l'âge de 1 an ne rentrent pas dans la statistique afin de ne pas biaiser la moyenne.<br />";
		...
		echo "En cliquant sur la période mentionnée au milieu, l'utilisateur peut visualiser la répartition des âges de décès des personnes pour la période concernée.";
		break;
	case 'Pyramide_Ages' : 
		echo "Cette page permet de visualiser la pyramide des âges au décès des personnes contenues dans la base.<br />";
		...
		echo "Le survol à la souris des barres du graphique permet de visualiser le nombre de personnes concernées pour un âge donné.";
		echo "De plus, on peut se débrancher sur la fiche de la doyenne ou du doyen.";
		break;
	case 'Pyramide_Ages_Mar_Histo' : 
		echo "Cette page permet de visualiser l'évolution (en fonction de l'année de naissance) de l'âge de premier mariage des personnes contenues dans la base.";
		echo "Si l'utilisateur n'a pas de profil privilégié, seules sont prises en compte les personnes dont la visibilité Internet est n'est pas restreinte.";
		echo "Le survol à la souris des barres du graphique permet de visualiser le nombre de personnes concernées sur la période.<br />";
		echo "En cliquant sur la période mentionnée au milieu, l'utilisateur peut visualiser la répartition des âges de premier mariage des personnes pour la période concernée.";
		break;
	...
	case 'Recherche_Personne' : 
		echo "Cette page permet à l'utilisateur d'effectuer une recherche multi-crtitère sur les personnes de la base.";
		...
		echo "La recherche phonétique exacte donne tous les noms se prononçant de la même façon.<br />";
		...
		echo "<ul>";
		echo "<li>&laquo; a &raquo; et &laquo; â &raquo; ;</li>";
		...
		echo "<p>La sortie du résultat de la recherche peut s'effectuer sous liste cliquable (sortie écran), sous format destiné à être imprimé (sortie texte) ou sous forme de fichier CSV (pour un tableur, le séparateur étant le ";" ; disponible à partir du profil privilégié).</p>";
		break;
	case 'Recherche_Ville' : 
		echo "Cette page permet à l'utilisateur d'effectuer une recherche multicritères sur les villes de la base.";
	...
	case 'Stat_Base_Depart' : 
		...
		echo "L'icone ".Affiche_Icone('carte_france','Carte de France')." permet de visualiser la répartition géographique sur la carte de la France.";
		break;
	...
	case 'Verif_Internet_Absente' : 
		echo "Cette page permet de visualiser les personnes non visibles sur Internet mais nées il y a plus ".$Lim_Diffu." ou décédées il y a plus de ".$Lim_Diffu_Dec." ans.";
		echo "L'utilisateur peut rectifier les incohérences en cliquant sur le bouton 'Rectifier'.";
		echo "Seules sont modifiées les lignes que l'utilisateur a cochées.";
	...
	case 'Verif_Internet' : 
		...
		echo "L'utilisateur peut rectifier les incohérences en cliquant sur le bouton 'Rectifier'.";
		echo "Seules sont modifiées les lignes que l'utilisateur a décochées.";
		...
		break;
	case 'Verif_Personne' : 
		echo "Cette page affiche le résultat du contrôle de la fiche d'une personne. Ils se font à plusieurs niveaux.";
	...
	case 'Liste_Noms_Non_Ut' :
		...
		break;
	case 'Rectif_Utf8' :
		echo "Lorsque l'on importe un fichier, par exemple lors d'un import Gedcom d'un fichier en UTF-8 sans avoir sélectionné l'option ad-hoc, il peut arriver que les caractères accentués et les \"ç\" sont mal retranscrits.<br />";
		echo "L'idée est alors de rectifier la base pour que ces caractères soient corrects.";
		break;
	case 'Verif_Homonymes' :	
		echo "Cette page permet d'afficher les homonymes présents dans la base. Ceux-ci sont triés par nom, prénoms, date de naissance et de date de décès.";
		...
		echo "Pour chaque couple nom – prénoms, on peut afficher 2 personnes en parallèle en les sélectionnant via les boutons radio et en cliquant sur l'icône ".Affiche_Icone('2personnes',$LG_Menu_Title['Compare_Persons']).".";
		break;
